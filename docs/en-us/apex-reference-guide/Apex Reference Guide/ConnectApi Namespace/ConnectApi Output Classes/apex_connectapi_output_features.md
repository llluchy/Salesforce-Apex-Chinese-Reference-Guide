---
doc_id: "apex_connectapi_output_features"
---
...
| --- | --- | --- | --- |
| `activityReminder​Notifications​Enabled` | Boolean | Reserved for future use.Specifies whether task reminder notifications are enabled. | 37.0 |
...
| `forecasting​PeriodType` | [`ConnectApi.​PeriodType`](atlas.en-us.apexref.meta/apexref/connectAPI_enums.htm#PeriodTypeEnum) | Time period used for forecasting. Values are:
-   `Month`
-   `Quarter`
-   `Week`
-   `Year`
...
| `mobile​Notifications​Enabled` | Boolean | Reserved for future use.Specifies whether notifications for mobile clients are enabled. | 29.0 |
