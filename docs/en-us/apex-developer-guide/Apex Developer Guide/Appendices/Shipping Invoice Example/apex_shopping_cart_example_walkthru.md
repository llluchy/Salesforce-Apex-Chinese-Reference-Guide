...
Flow of user action and triggers for the shopping cart application ![Flow of user action and triggers for shopping cart application](/docs/resources/img/en-us/262.0?doc_id=dev_guides%2Fapex%2Fimages%2Fshopping_cart_app_flow.png&folder=apexcode)
